...
Route::model('grant', 'App\Models\Grant');
...
Route::group(['prefix' => 'accounting'], function () {
    //gl account
    Route::get('gl_account/data', 'GlAccountController@index');
    ...
    Route::get('journal/{id}/delete', 'JournalController@delete');
    //reconciliation
...
Route::group(['prefix' => 'report'], function () {
    ...
    Route::any('grant_report', 'ReportController@grant_report');
    ...
    Route::group(['prefix' => 'grant_report'], function () {
        Route::any('disbursement_report', 'ReportController@grant_disbursement_report');
        Route::any('disbursement_report/pdf', 'ReportController@grant_disbursement_report_pdf');
        Route::any('disbursement_report/excel', 'ReportController@grant_disbursement_report_excel');
        Route::any('disbursement_report/csv', 'ReportController@grant_disbursement_report_csv');
        Route::any('repayments_report', 'ReportController@repayments_report');
        Route::any('repayments_report/pdf', 'ReportController@repayments_report_pdf');
        Route::any('repayments_report/excel', 'ReportController@repayments_report_excel');
        Route::any('repayments_report/csv', 'ReportController@repayments_report_csv');
...
Route::group(['prefix' => 'grant'], function () {
    Route::get('data', 'GrantController@index');
    Route::get('pending_approval', 'GrantController@pending_approval');
    Route::get('awaiting_disbursement', 'GrantController@awaiting_disbursement');
    Route::get('grants_declined', 'GrantController@grants_declined');
    Route::get('grants_written_off', 'GrantController@grants_written_off');
    Route::get('grants_closed', 'GrantController@grants_closed');
    Route::get('create', 'GrantController@create');
    Route::post('store', 'GrantController@store');
    Route::get('{grant}/edit', 'GrantController@edit');
    Route::get('{grant}/show', 'GrantController@show');
    Route::post('{id}/update', 'GrantController@update');
    Route::get('{id}/delete', 'GrantController@delete');
    Route::post('{id}/approve', 'GrantController@approve_grant');
    Route::post('{id}/decline', 'GrantController@decline_grant');
    Route::get('{id}/unapprove', 'GrantController@unapprove_grant');
    Route::post('{id}/disburse', 'GrantController@disburse_grant');
    Route::get('{id}/undisburse', 'GrantController@undisburse_grant');
    Route::post('{id}/withdraw', 'GrantController@withdraw_grant');
    Route::post('{id}/change_grant_officer', 'GrantController@change_grant_officer');
    Route::get('{grant}/email_schedule', 'GrantController@email_schedule');
    Route::get('{grant}/print_schedule', 'GrantController@print_schedule');
    Route::get('{grant}/pdf_schedule', 'GrantController@pdf_schedule');
    //document
    Route::post('{id}/document/store', 'GrantController@store_grant_document');
    Route::get('document/{id}/delete', 'GrantController@delete_grant_document');
    //notes
    Route::post('{id}/note/store', 'GrantController@store_note');
    Route::get('note/{id}/delete', 'GrantController@delete_note');
    Route::get('note/{note}/show', 'GrantController@show_note');
    Route::get('note/{note}/edit', 'GrantController@edit_note');
    Route::post('note/{id}/update', 'GrantController@update_note');
    //guarantor
    Route::post('{id}/guarantor/store', 'GrantController@store_guarantor');
    Route::get('guarantor/{id}/delete', 'GrantController@delete_guarantor');
    Route::get('guarantor/{guarantor}/show', 'GrantController@show_guarantor');
    Route::get('guarantor/{guarantor}/edit', 'GrantController@edit_guarantor');
    Route::post('guarantor/{id}/update', 'GrantController@update_guarantor');
