...
@section('content')
    ...
    @if(!Sentinel::inRole('client'))
        ...
        <div class="row">
            @if(Sentinel::hasAccess('dashboard.grants_status_overview'))
                <div class="col-md-4">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">{{ trans_choice('general.grant',2) }} {{ trans_choice('general.status',1) }} {{ trans_choice('general.overview',2) }}</h3>
                        ...
                        <!-- /.box-header -->
                        <div class="box-body" id="">
                            <div id="grants_status_graph" style="height: 300px;"></div>
            ...
            @endif
            @if(Sentinel::hasAccess('dashboard.grants_disbursement_overview'))
                <div class="col-md-8">
                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="info-box">
                                <span class="info-box-icon bg-green"><i class="fa fa-money"></i></span>
                                <div class="info-box-content">
                                    <span class="info-box-text">{{ trans_choice('general.total',2) }} {{ trans_choice('general.grant',2) }} {{ trans_choice('general.disbursed',2) }}</span>
                                    <span class="info-box-number">{{number_format(\App\Helpers\GeneralHelper::total_grants_disbursed(),2)}}</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="info-box">
                                <span class="info-box-icon bg-green"><i class="fa fa-money"></i></span>
                                <div class="info-box-content">
                                    <span class="info-box-text">{{ trans_choice('general.grant',2) }} {{ trans_choice('general.disbursed',2) }} {{ trans_choice('general.this',1) }} {{ trans_choice('general.week',1) }}</span>
                                    <span class="info-box-number">{{number_format(\App\Helpers\GeneralHelper::total_grants_disbursed(\Illuminate\Support\Carbon::today()->startOfWeek(),\Illuminate\Support\Carbon::today()->endOfWeek()),2)}}</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="info-box">
                                <span class="info-box-icon bg-green"><i class="fa fa-money"></i></span>
                                <div class="info-box-content">
                                    <span class="info-box-text">{{ trans_choice('general.grant',2) }} {{ trans_choice('general.disbursed',2) }} {{ trans_choice('general.this',1) }} {{ trans_choice('general.month',1) }}</span>
                                    <span class="info-box-number">{{number_format(\App\Helpers\GeneralHelper::total_grants_disbursed(\Illuminate\Support\Carbon::today()->startOfMonth(),\Illuminate\Support\Carbon::today()->endOfMonth()),2)}}</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="info-box">
                                <span class="info-box-icon bg-green"><i class="fa fa-money"></i></span>
                                <div class="info-box-content">
                                    <span class="info-box-text">{{ trans_choice('general.grant',2) }} {{ trans_choice('general.disbursed',2) }} {{ trans_choice('general.this',1) }} {{ trans_choice('general.year',1) }}</span>
                                    <span class="info-box-number">{{number_format(\App\Helpers\GeneralHelper::total_grants_disbursed(\Illuminate\Support\Carbon::today()->startOfYear(),\Illuminate\Support\Carbon::today()->endOfYear()),2)}}</span>
                                </div>
                            </div>
                        </div>
                    </div>
...
@section('footer-scripts')
    ...
    @if(!Sentinel::inRole('client'))
        <script>
            ...
            var chart = AmCharts.makeChart("grants_status_graph", {
                "type": "pie",
                "theme": "light",
                "dataProvider": {!! \App\Helpers\GeneralHelper::grants_status_graph() !!},
                "balloon": {
                    "fixedPosition": false
                },
                "valueField": "value",
