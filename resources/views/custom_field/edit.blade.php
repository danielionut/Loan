                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <select name="category" class="form-control select2" id="category" required>
                                ...
                                <option value="repayments"
                                        @if($custom_field->category=="repayments") selected @endif>{{trans_choice('general.repayment',2)}}</option>
                                <option value="grants"
                                        @if($custom_field->category=="grants") selected @endif>{{trans_choice('general.grant',2)}}</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
