<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            @endif
            @if(Sentinel::hasAccess('grants'))
                <li class="treeview @if(Request::is('grant/*')) active @endif">
                    <a href="#">
                        <i class="fa fa-money"></i> <span>{{trans_choice('general.grant',2)}}</span>
                        <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
                    </a>
                    <ul class="treeview-menu">
                        @if(Sentinel::hasAccess('grants.view'))
                            <li><a href="{{ url('grant/data') }}"><i
                                            class="fa fa-circle-o"></i> {{trans_choice('general.disbursed',1)}} {{trans_choice('general.grant',2)}}
                                    <span class="pull-right-container">
                                        <span class="label label-info pull-right">{{\App\Models\Grant::where('status','disbursed')->count() }}</span>
                                    </span>
                                </a></li>
                        @endif
                        @if(Sentinel::hasAccess('grants.pending_approval'))
                            <li>
                                <a href="{{ url('grant/pending_approval') }}"><i
                                            class="fa fa-circle-o"></i> {{trans_choice('general.pending',1)}} {{trans_choice('general.approval',1)}}
                                    <span class="pull-right-container">
                                        <span class="label label-warning pull-right">{{\App\Models\Grant::where('status','pending')->count() }}</span>
                                    </span>
                                </a>
                            </li>
                        @endif
                        @if(Sentinel::hasAccess('grants.awaiting_disbursement'))
                            <li>
                                <a href="{{ url('grant/awaiting_disbursement') }}"><i
                                            class="fa fa-circle-o"></i> {{trans_choice('general.awaiting',1)}} {{trans_choice('general.disbursement',1)}}
                                    <span class="pull-right-container">
                                        <span class="label label-info pull-right">{{\App\Models\Grant::where('status','approved')->count() }}</span>
                                    </span>
                                </a>
                            </li>
                        @endif
                        @if(Sentinel::hasAccess('grants.declined'))
                            <li>
                                <a href="{{ url('grant/grants_declined') }}"><i
                                            class="fa fa-circle-o"></i> {{trans_choice('general.grant',2)}} {{trans_choice('general.declined',1)}}
                                    <span class="pull-right-container">
                                        <span class="label label-danger pull-right">{{\App\Models\Grant::where('status','declined')->count() }}</span>
                                    </span>
                                </a>
                            </li>
                        @endif
                        @if(Sentinel::hasAccess('grants.create'))
                            <li><a href="{{ url('grant/create') }}"><i
                                            class="fa fa-circle-o"></i> {{trans_choice('general.add',2)}} {{trans_choice('general.grant',1)}}
                                </a></li>
                        @endif
                    </ul>
                </li>
            ...
            @if(Sentinel::hasAccess('reports'))
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        ...
                        @endif
                        @if(Sentinel::hasAccess('reports.grant_reports'))
                            <li><a href="{{ url('report/grant_report') }}"><i
                                            class="fa fa-circle-o"></i> {{trans_choice('general.grant',1)}} {{trans_choice('general.report',2)}}
                                </a></li>
                        @endif
