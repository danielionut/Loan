...
@section('title')
    {{ trans_choice('general.grant',2) }} {{ trans_choice('general.declined',1) }}
@endsection
@section('content')
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title"> {{ trans_choice('general.grant',2) }} {{ trans_choice('general.declined',1) }}</h3>
