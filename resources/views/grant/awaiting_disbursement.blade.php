...
@section('title')
    {{ trans_choice('general.awaiting',1) }} {{ trans_choice('general.disbursement',1) }}
@endsection
@section('content')
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans_choice('general.awaiting',1) }} {{ trans_choice('general.disbursement',1) }}</h3>
        ...
        <div class="box-body table-responsive">
            <table class="table  table-bordered table-hover table-striped" id="data-table">
                ...
                <tr>
                    ...
                    <th>{{ trans_choice('general.approved',1) }} {{ trans_choice('general.amount',1) }}</th>
                ...
                @foreach($data as $key)
                    <tr>
                        ...
                        <td>{{ number_format($key->approved_amount,$key->decimals) }}</td>
