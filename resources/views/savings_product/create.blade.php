                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <select name="charges_dropdown" class="form-control select2" id="charges_dropdown">
                            <option></option>
                            @foreach(\App\Models\Charge::where('currency_id', \App\Models\Setting::where('setting_key','company_currency')->first()->setting_value)->where('active', 1)->where('product', "savings")->get() as $key)
