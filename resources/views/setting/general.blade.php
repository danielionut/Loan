                                ...
                                <div class="col-sm-10">
                                    <select name="payroll_gl_account_expense_id" class="form-control"
                                        ...
                                        @foreach(\App\Models\GlAccount::where('active',1)->where('account_type',"expense")->get() as $key)
                                            <option value="{{$key->id}}"
                                                    @if(\App\Models\Setting::where('setting_key','payroll_gl_account_expense_id')->first()->setting_value==$key->id) selected @endif>{{$sms_gateway->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-10">
                                    <select name="payroll_gl_account_asset_id" class="form-control"
                                        ...
                                        @foreach(\App\Models\GlAccount::where('active',1)->where('account_type',"asset")->get() as $key)
                                            <option value="{{$key->id}}"
                                                    @if(\App\Models\Setting::where('setting_key','payroll_gl_account_asset_id')->first()->setting_value==$key->id) selected @endif>{{$sms_gateway->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
