...
@section('content')
    <div class="box box-primary">
        ...
        <form method="post" action="{{url('loan/product/store')}}" class="form-horizontal"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <select name="interest_rate_type" class="form-control " id="interest_rate_type"
                                required>
                            <option value="month">{{trans_choice('general.per',2)}} {{trans_choice('general.month',1)}}</option>
                            <option value="year">{{trans_choice('general.per',2)}} {{trans_choice('general.year',1)}}</option>
                        </select>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <select name="interest_method" class="form-control " id="interest_method"
                            ...
                            <option value="declining_balance">{{trans_choice('general.declining_balance',1)}}</option>
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <select name="armotization_method" class="form-control " id="armotization_method"
                                required>
                            <option value="equal_installment">{{trans_choice('general.equal_installment',1)}}</option>
                            <option value="declining_balance">{{trans_choice('general.declining_balance',1)}}</option>
                        </select>
                    </div>
                    <label for="year_days"
                    ...
                    <div class="col-md-3">
                        <select name="year_days" class="form-control " id="year_days"
                                required>
                            <option value="actual">{{trans_choice('general.actual',1)}}</option>
                            <option value="360">360 {{trans_choice('general.day',2)}}</option>
                            <option value="364">364 {{trans_choice('general.day',2)}}</option>
                            <option value="365">365 {{trans_choice('general.day',2)}}</option>
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <select name="month_days" class="form-control " id="month_days"
                                required>
                            <option value="actual">{{trans_choice('general.actual',1)}}</option>
                            <option value="30">30 {{trans_choice('general.day',2)}}</option>
                        </select>
                    </div>
                    ...
                    <div class="col-md-3">
                        <select name="loan_transaction_strategy" class="form-control " id="loan_transaction_strategy"
                                required>
                            <option value="penalty_fees_interest_principal">{{trans_choice('general.penalty_fees_interest_principal',1)}}</option>
                            <option value="principal_interest_penalty_fees">{{trans_choice('general.principal_interest_penalty_fees',1)}}</option>
                            <option value="interest_principal_penalty_fees">{{trans_choice('general.interest_principal_penalty_fees',1)}}</option>
                        </select>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <select name="charges_dropdown" class="form-control select2" id="charges_dropdown">
                            <option></option>
                            @foreach(\App\Models\Charge::where('currency_id', \App\Models\Setting::where('setting_key','company_currency')->first()->setting_value)->where('active', 1)->where('product', "loan")->get() as $key)
                                <option value="{{$key->id}}">{{$key->name}}</option>
                            @endforeach
                        </select>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <select name="accounting_rule" class="form-control select2"
                            ...
                            <option value="accrual_periodic">{{trans_choice('general.accrual_periodic',1)}}</option>
                            <option value="accrual_upfront">{{trans_choice('general.accrual_upfront',1)}}</option>
                        </select>
                    </div>
                </div>
                <div id="accounting">
